...
public class Career {
    ...
    @Builder
    public Career(User user, String company, String position, String department, String type, LocalDate startDate, LocalDate endDate, boolean isCurrent, String location, String description, String skills) {
        this.user = user;
