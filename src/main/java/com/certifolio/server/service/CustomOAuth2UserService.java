...
import com.certifolio.server.domain.Role;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // Let's stick to returning default OAuth2User with our attributes map if needed.
        // Or simpler, we just use the attributes in SuccessHandler to find the user again.
        
        return oAuth2User; // We will look up user by email/providerId in SuccessHandler if needed, or put info in attributes.
    }
    ...
    private User saveOrUpdate(OAuth2UserInfo oAuth2UserInfo) {
        ...
        if (userOptional.isPresent()) {
            ...
            user.update(oAuth2UserInfo.getName(), null); // Update profile, email usually doesn't change or we don't update it blindly
        } else {
            user = User.builder()
